    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_communication_unit', models.BooleanField(default=False, verbose_name='начальная точка связи?')),
                ('end_communication_unit', models.BooleanField(default=False, verbose_name='конечная точка связи?')),
            ],
            options={
                'verbose_name': 'Блок',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_place_towers', models.BooleanField(default=False, help_text='\n            Установите флажок, если хотите,\n            чтобы вышки расставлялись автоматически.\n        ', verbose_name='Автоматическая расстановка вышек')),
            ],
            options={
