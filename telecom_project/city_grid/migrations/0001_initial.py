# Generated by Django 4.2.7 on 2023-11-09 06:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coverage_threshold', models.PositiveIntegerField(default=30, verbose_name='Минимальный % покрытия')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covered_blocks', models.ManyToManyField(blank=True, to='city_grid.block')),
